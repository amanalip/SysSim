    ...
    <div className={styles.drawerContainer}>
      ...
      <div className={styles.drawerBody}>
        {activeBottomTab === 'metrics' && (
          <ModelNotice
            kind="simulation"
            detail="Telemetry is synthetic: counters are lifetime totals, rates are the latest one-second interval, and latency statistics use recent bounded completions."
